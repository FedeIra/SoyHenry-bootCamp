...
document.querySelector("#createdBy").innerHTML += " Fede";

// Otra forma:
/* let intro = document.querySelector("#createdBy");

intro.innerHTML = "Aplicación creada por Fede"; */
...
function displayToDos() {
  ...
  /* arreglo.forEach(element => (toDoContainer.appendChild((element)) */
}
